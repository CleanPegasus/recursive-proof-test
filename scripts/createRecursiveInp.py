...
with open('circuit-output/verification_key.json', 'r') as vkey_file:
...
recursiveProofInput = {
    ...
    "pubParameters": pubParameters
}

jsonString = json.dumps(recursiveProofInput, indent=2)

with open('recursiveProofInput.json', 'w') as json_file:
    json.dump(recursiveProofInput, json_file, indent=2)
